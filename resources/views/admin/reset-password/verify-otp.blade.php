...
<div class="mi-content">
    <div class="row w-100">
        <div class="col-sm-5 m-auto">
            <div class="mi-card">
                <div class="mi-header success">FORGOT PASSWORD : VERIFICATION</div>
                <form onsubmit="return loader()" action="{{ route('reset-password.verify-otp') }}" method="POST">
                    @csrf
                    <div class="mi-body">
                        <input type="hidden" name="email" id="email" class="form-control" value="{{ $email }}" required>
                        <div class="form-group">
                            <label for="">WE SENT AN OTP TO YOUR EMAIL . PLEASE CHECK AND ENTER HERE</label>
                    ...
                    <div class="mi-footer">
                        <div class="row">
                            <div class="col-sm-5 m-auto">
                                <button class="butn success w-100">VERIFY</button>
                            </div>
                        </div>
                    </div>
                </form>
